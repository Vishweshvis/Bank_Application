...
<body>
 <!-- ======= Header ======= -->
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="row">
                  ...
                  <h5 class="card-title">Bank Balance<span>| current</span></h5>
                    ...
                    <div class="ps-3">
                      ...
                      <div class="balance">
                        ...
                        <h2><span id="balance"><%=amount %> 0.00</span></h2>
                        
                    </div>
                      <span class="text-success small pt-1 fw-bold"></span> <span class="text-muted small pt-2 ps-1">INR</span>
            ...
            <!--Button for withdrawl and deposit-->
            <div class="button-container">
              <div>
              
              </div>
              <button class="btn deposit-btn" onclick="location.href='deposit.html'">Deposit</button>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Quziee Bank</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
